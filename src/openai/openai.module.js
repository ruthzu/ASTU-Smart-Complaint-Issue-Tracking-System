...
exports.OpenAIModule = OpenAIModule = __decorate([
    ...
    (0, common_1.Module)({
        ...
        providers: [openai_service_1.OpenAIService, ai_service_1.AiService, prisma_service_1.PrismaService],
        exports: [openai_service_1.OpenAIService, ai_service_1.AiService],
    })
], OpenAIModule);
